...
sourcedir=/root/mysql-cluster-gpl-7.4.10
builddir=/root/mysql-cluster-gpl-7.4.10
installdir=/usr/local/kcj_cluster/mysql
...
scriptsdir=scripts
sharedir=share
memcachedbin=/usr/local/kcj_cluster/mysql/bin/memcached
