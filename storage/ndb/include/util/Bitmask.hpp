...
public:
  ...
  static void setEach(unsigned size, Uint32 data[], unsigned n1, unsigned n2);
...
//
inline void
BitmaskImpl::setEach(unsigned size, Uint32 data[], unsigned n1, unsigned n2)
{
    assert(n1 < (size << 5) && n2 < (size << 5));
...
//KCJ
  ...
  static void setEach(Uint32 data[], unsigned n1, unsigned n2);
  void setEach(unsigned n1, unsigned n2);
...
template <unsigned size>
inline void
BitmaskPOD<size>::setEach(Uint32 data[], unsigned n1, unsigned n2)
{
  BitmaskImpl::setEach(size, data, n1, n2);
}


template <unsigned size>
inline void
BitmaskPOD<size>::setEach(unsigned n1, unsigned n2)
{
  BitmaskPOD<size>::setEach(rep.data, n1, n2);
}
